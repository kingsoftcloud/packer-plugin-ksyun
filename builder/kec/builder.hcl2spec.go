// Code generated by "mapstructure-to-hcl2 -type Config,KsyunDiskDevice,KsyunEbsDataDisk"; DO NOT EDIT.
...
type FlatConfig struct {
	...
	SnapshotIds               []FlatKsyunDiskDevice  `mapstructure:"snapshot_ids" required:"false" cty:"snapshot_ids" hcl:"snapshot_ids"`
	DataDiskIds               []FlatKsyunDiskDevice  `mapstructure:"data_disk_ids" required:"false" cty:"data_disk_ids" hcl:"data_disk_ids"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"snapshot_ids":                 &hcldec.BlockListSpec{TypeName: "snapshot_ids", Nested: hcldec.ObjectSpec((*FlatKsyunDiskDevice)(nil).HCL2Spec())},
		"data_disk_ids":                &hcldec.BlockListSpec{TypeName: "data_disk_ids", Nested: hcldec.ObjectSpec((*FlatKsyunDiskDevice)(nil).HCL2Spec())},
...
// FlatKsyunDiskDevice is an auto-generated flat version of KsyunDiskDevice.
// Where the contents of a field with a `mapstructure:,squash` tag are bubbled up.
type FlatKsyunDiskDevice struct {
...
// FlatMapstructure returns a new FlatKsyunDiskDevice.
// FlatKsyunDiskDevice is an auto-generated flat version of KsyunDiskDevice.
// Where the contents a fields with a `mapstructure:,squash` tag are bubbled up.
func (*KsyunDiskDevice) FlatMapstructure() interface{ HCL2Spec() map[string]hcldec.Spec } {
	return new(FlatKsyunDiskDevice)
}

// HCL2Spec returns the hcl spec of a KsyunDiskDevice.
// This spec is used by HCL to read the fields of KsyunDiskDevice.
// The decoded values from this spec will then be applied to a FlatKsyunDiskDevice.
func (*FlatKsyunDiskDevice) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
