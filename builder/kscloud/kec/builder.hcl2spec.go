// Code generated by "mapstructure-to-hcl2 -type Config,KingcloudDiskDevice,KingcloudEbsDataDisk"; DO NOT EDIT.
...
type FlatConfig struct {
	...
	KingcloudAccessKey        *string                    `mapstructure:"access_key" required:"true" cty:"access_key" hcl:"access_key"`
	KingcloudSecretKey        *string                    `mapstructure:"secret_key" required:"true" cty:"secret_key" hcl:"secret_key"`
	KingcloudRegion           *string                    `mapstructure:"region" required:"true" cty:"region" hcl:"region"`
	KingcloudImageName        *string                    `mapstructure:"image_name" required:"true" cty:"image_name" hcl:"image_name"`
	KingcloudImageType        *string                    `mapstructure:"image_type" required:"false" cty:"image_type" hcl:"image_type"`
	SnapshotIds               []FlatKingcloudDiskDevice  `mapstructure:"snapshot_ids" required:"false" cty:"snapshot_ids" hcl:"snapshot_ids"`
	DataDiskIds               []FlatKingcloudDiskDevice  `mapstructure:"data_disk_ids" required:"false" cty:"data_disk_ids" hcl:"data_disk_ids"`
	...
	KingcloudEbsDataDisks     []FlatKingcloudEbsDataDisk `mapstructure:"data_disks" required:"false" cty:"data_disks" hcl:"data_disks"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"snapshot_ids":                 &hcldec.BlockListSpec{TypeName: "snapshot_ids", Nested: hcldec.ObjectSpec((*FlatKingcloudDiskDevice)(nil).HCL2Spec())},
		"data_disk_ids":                &hcldec.BlockListSpec{TypeName: "data_disk_ids", Nested: hcldec.ObjectSpec((*FlatKingcloudDiskDevice)(nil).HCL2Spec())},
		...
		"data_disks":                   &hcldec.BlockListSpec{TypeName: "data_disks", Nested: hcldec.ObjectSpec((*FlatKingcloudEbsDataDisk)(nil).HCL2Spec())},
...
// FlatKingcloudDiskDevice is an auto-generated flat version of KingcloudDiskDevice.
// Where the contents of a field with a `mapstructure:,squash` tag are bubbled up.
type FlatKingcloudDiskDevice struct {
...
// FlatMapstructure returns a new FlatKingcloudDiskDevice.
// FlatKingcloudDiskDevice is an auto-generated flat version of KingcloudDiskDevice.
// Where the contents a fields with a `mapstructure:,squash` tag are bubbled up.
func (*KingcloudDiskDevice) FlatMapstructure() interface{ HCL2Spec() map[string]hcldec.Spec } {
	return new(FlatKingcloudDiskDevice)
}

// HCL2Spec returns the hcl spec of a KingcloudDiskDevice.
// This spec is used by HCL to read the fields of KingcloudDiskDevice.
// The decoded values from this spec will then be applied to a FlatKingcloudDiskDevice.
func (*FlatKingcloudDiskDevice) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
...
// FlatKingcloudEbsDataDisk is an auto-generated flat version of KingcloudEbsDataDisk.
// Where the contents of a field with a `mapstructure:,squash` tag are bubbled up.
type FlatKingcloudEbsDataDisk struct {
...
// FlatMapstructure returns a new FlatKingcloudEbsDataDisk.
// FlatKingcloudEbsDataDisk is an auto-generated flat version of KingcloudEbsDataDisk.
// Where the contents a fields with a `mapstructure:,squash` tag are bubbled up.
func (*KingcloudEbsDataDisk) FlatMapstructure() interface{ HCL2Spec() map[string]hcldec.Spec } {
	return new(FlatKingcloudEbsDataDisk)
}

// HCL2Spec returns the hcl spec of a KingcloudEbsDataDisk.
// This spec is used by HCL to read the fields of KingcloudEbsDataDisk.
// The decoded values from this spec will then be applied to a FlatKingcloudEbsDataDisk.
func (*FlatKingcloudEbsDataDisk) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
